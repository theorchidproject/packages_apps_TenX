...
public class UserInterface extends SettingsPreferenceFragment implements
    ...
    private SystemSettingListPreference mThemeSwitch;
    ...
    private void setupThemeSwitchPref() {
        mThemeSwitch = (SystemSettingListPreference) findPreference(PREF_THEME_SWITCH);
        mThemeSwitch.setOnPreferenceChangeListener(this);
        if (tenxUtils.isThemeEnabled("com.android.theme.darkgrey.system")) {
            mThemeSwitch.setValue("7");
        } else if (tenxUtils.isThemeEnabled("com.android.theme.pitchblack.system")) {
            mThemeSwitch.setValue("6");
        } else if (tenxUtils.isThemeEnabled("com.android.theme.materialocean.system")) {
            mThemeSwitch.setValue("8");
        } else if (tenxUtils.isThemeEnabled("com.android.theme.chocox.system")) {
            mThemeSwitch.setValue("5");
        } else if (tenxUtils.isThemeEnabled("com.android.theme.bakedgreen.system")) {
            mThemeSwitch.setValue("4");
        } else if (tenxUtils.isThemeEnabled("com.android.theme.solarizeddark.system")) {
